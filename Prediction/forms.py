...
class PredictForm(ModelForm):
    class Meta:
        ...
        placeholders = {
            ...
            # 'name' : 'Enter your name',
            # 'pregnancy': 'Enter number of times pregnant(0-13)',
            # 'glucose' : 'Enter your glucose level(0-200)',
            # 'bloodPressure':'Enter your blood pressure(0-110)',
            # 'skinThickness': 'Enter your skin thickness(0-85)',
            # 'insulin':'Enter your insulin level(0-350)',
            # 'bmi':'Enter your body mass index(0-60)',
            # 'diabetesPedigree':'Enter your diabetes predigree function(0.01-1.25)',
            # 'age' : 'Enter your age(20-70)'
        }
